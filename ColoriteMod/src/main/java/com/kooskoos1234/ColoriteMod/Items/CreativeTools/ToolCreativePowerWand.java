...
public class ToolCreativePowerWand extends Item implements IHasModel
{
	public ToolCreativePowerWand(String name)
	{
		super();
	...
	{
		playerIn.addPotionEffect(new PotionEffect(MobEffects.STRENGTH, (1200), 0, false, false));
