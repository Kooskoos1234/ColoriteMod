...
public class ToolCreativeEnduranceWand extends Item implements IHasModel
{
	public ToolCreativeEnduranceWand(String name)
	{
		super();
	...
	{
		playerIn.addPotionEffect(new PotionEffect(MobEffects.ABSORPTION, 600, 4, false, false));
