...
public class AutosmeltEnchant extends Enchantment
{
	public AutosmeltEnchant(Rarity rarityIn, EnumEnchantmentType typeIn, EntityEquipmentSlot[] slots) 
	{
		super(rarityIn, typeIn, slots);
		this.setName("enchant_autosmelt");
		this.setRegistryName(new ResourceLocation(Reference.MOD_ID + ":enchant_autosmelt"));
