...
{
	public DashEnchant(Rarity rarityIn, EnumEnchantmentType typeIn, EntityEquipmentSlot[] slots) 
	{
		super(rarityIn, typeIn, slots);
		this.setName("enchant_dash");
		this.setRegistryName(new ResourceLocation(Reference.MOD_ID + ":enchant_dash"));
