...
public class RecoveryEnchant extends Enchantment
{
	public RecoveryEnchant(Rarity rarityIn, EnumEnchantmentType typeIn, EntityEquipmentSlot[] slots) 
	{
		super(rarityIn, typeIn, slots);
		this.setName("enchant_recovery");
		this.setRegistryName(new ResourceLocation(Reference.MOD_ID + ":enchant_recovery"));
