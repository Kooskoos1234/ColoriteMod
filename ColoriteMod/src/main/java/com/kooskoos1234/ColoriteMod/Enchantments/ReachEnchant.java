...
{
	public ReachEnchant(Rarity rarityIn, EnumEnchantmentType typeIn, EntityEquipmentSlot[] slots) 
	{
		super(rarityIn, typeIn, slots);
		this.setName("enchant_reach");
		this.setRegistryName(new ResourceLocation(Reference.MOD_ID + ":enchant_reach"));
