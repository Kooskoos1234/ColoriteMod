...
public class FireImmunityEnchant extends Enchantment
{
	public FireImmunityEnchant(Rarity rarityIn, EnumEnchantmentType typeIn, EntityEquipmentSlot[] slots) 
	{
		super(rarityIn, typeIn, slots);
		this.setName("enchant_fire_immunity");
		this.setRegistryName(new ResourceLocation(Reference.MOD_ID + ":enchant_fire_immunity"));
