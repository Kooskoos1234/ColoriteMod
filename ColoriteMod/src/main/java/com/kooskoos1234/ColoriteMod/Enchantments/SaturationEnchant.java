...
public class SaturationEnchant extends Enchantment 
{
	...
	public SaturationEnchant(Rarity rarityIn, EnumEnchantmentType typeIn, EntityEquipmentSlot[] slots) 
	{
		super(rarityIn, typeIn, slots);
		this.setName("enchant_saturation");
		this.setRegistryName(new ResourceLocation(Reference.MOD_ID + ":enchant_saturation"));
