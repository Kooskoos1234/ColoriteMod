...
public class LifeStealEnchant extends Enchantment 
{
	...
	public LifeStealEnchant(Rarity rarityIn, EnumEnchantmentType typeIn, EntityEquipmentSlot[] slots) 
	{
		super(rarityIn, typeIn, slots);
		this.setName("enchant_life_steal");
		this.setRegistryName(new ResourceLocation(Reference.MOD_ID + ":enchant_life_steal"));
